    ...
    <div class="container-fluid">
        ...
        <div class="row pr-lg-3 pl-lg-3 justify-content-center">
            <div class="col-lg-12">
                ...
                <div class="form-group row">
                    <label for="ig" class="col-4 col-lg-3 pt-lg-2 col-form-label">Instagram</label>
                    <span class="col-1 col-lg-1 pt-lg-2"> : </span>
                    <div class="col-12 col-lg-8">
                ...
                <div class="form-group row">
                    <label for="phone" class="col-7 col-lg-3 pt-lg-2 col-form-label">Phone Number/WA Alternative</label>
                    <span class="col-1 col-lg-1 pt-lg-2"> : </span>
                    <div class="col-12 col-lg-8">
                ...
                <div class="form-group row">
                    <label for="zip" class="col-4 col-lg-3 pt-lg-2 col-form-label">Postal Code</label>
                    <span class="col-1 col-lg-1 pt-lg-2"> : </span>
                    <div class="col-12 col-lg-8">
                ...
                <div class="form-group row">
                    <label for="country" class="col-4 col-lg-3 pt-lg-2 col-form-label">Country</label>
                    <span class="col-1 col-lg-1 pt-lg-2"> : </span>
                    <div class="col-12 col-lg-8">
                ...
                <?php if (substr($this->session->userdata('id'), 0, 1) == 1) { ?>
                    <div class="form-group row">
                        ...
                        <div class="col-9 col-lg-4">
                            <input type="password" class="form-control login-form pwd bg-white" readonly required name="password" id="inputPassword" value="<?= $student[0]['password_parent'] ?>">
                        </div>

...
class C_Admin extends CI_Controller
{
    ...
    function get_ajax_offline_lesson2()
    {
        ...
        foreach ($list as $item) {
            ...
            $buttonDlt = '';
            if ($count_ongoing == 0 && $count_done == 0 && $count_cancel == 0) {
                $buttonDlt = '<a href="' . site_url('portal/C_Admin/delete_data_online_pratical/' . $item->id_list_package_offline . '/' . str_replace("/", "-", $item->no_transaksi_package_offline)) . '" class="btn btn-danger" title="Hapus Data Ini" onclick=\'return confirm("are you sure want to delete this data?")\'><i class="fa fa-trash icon-white"></i></a>';

...
class M_Admin extends CI_Model
{
    ...
    {
        $this->db->select('lp.id_list_package_offline, lp.total_package, lp.rate_dollar, lp.rate, lp.id_student, lp.discount, s.name_student, p.name, p.price_idr, p.price_dollar, p.price_euro, p.duration, t.name_teacher, lp.no_transaksi_package_offline, s.currency, lp.rate_package');
